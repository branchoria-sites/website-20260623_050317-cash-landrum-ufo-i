...
show_ads: true
description: Cash's nausea, diarrhoea, and weakness sound severe, but radiation explanations have to match dose, blood findings, and survival patterns.
hero_summary: Cash's nausea, diarrhoea, and weakness sound severe, but radiation explanations have to match dose, blood findings, and survival patterns.
layout: default
permalink: /gi-symptoms/
sidebar_expanded_urls:
- /cash-landrum-ufo-incident/
- /hair-loss/
nav_short_title: GI Symptoms
title: Did the Sickness Match Radiation Exposure?
title_full: Did the Sickness Match Radiation Exposure?
display_title_short: GI Symptoms
display_title: GI Symptoms
heading_title: Did the Sickness Match Radiation Exposure?
page_heading_title: Did the Sickness Match Radiation Exposure?
source_count: 37
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why Landrum's Hair Timeline Matters
header:
  og_image: /assets/images/cash_landrum_ufo_inc_db9d45_hair_loss_symptoms_d_4aff86_gi_symptoms_radiatio_7f8d61-Illustration-1-social.jpg
  preview_image: /assets/images/cash_landrum_ufo_inc_db9d45_hair_loss_symptoms_d_4aff86_gi_symptoms_radiatio_7f8d61-Illustration-1.webp
image: /assets/images/cash_landrum_ufo_inc_db9d45_hair_loss_symptoms_d_4aff86_gi_symptoms_radiatio_7f8d61-Illustration-1-social.jpg
---
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explores real-world radiation injuries and how symptoms were documented.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Illustrates how severe illness patterns are evaluated against biological evidence.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Helps readers understand radiation exposure and dose interpretation claims.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.amazon.com/s?k=DEADLY+FEASTS+CASSETTE+Richard+Rhodes&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" aria-label="Open DEADLY FEASTS CASSETTE on Amazon"><span class="fr-book-cover-fallback">Book</span><img class="fr-book-cover-thumb" src="https://covers.openlibrary.org/b/id/1334453-M.jpg" alt="Cover for DEADLY FEASTS CASSETTE" loading="lazy" decoding="async" fetchpriority="low" referrerpolicy="no-referrer" onerror="this.hidden=true;this.closest('.fr-book-cover').classList.add('fr-book-cover-placeholder');"></a>
      <div class="fr-book-info">
        <h4 class="fr-book-title">
          <a href="https://www.amazon.com/s?k=DEADLY+FEASTS+CASSETTE+Richard+Rhodes&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" title="DEADLY FEASTS CASSETTE">DEADLY FEASTS CASSETTE</a>
        </h4>
        <p class="fr-book-author">By Richard Rhodes</p>

        <p class="fr-book-desc">First published 1997. Subjects: Prion diseases, Popular works, Maladies à prions, Ouvrages de vulgarisation, Plague.</p>
        <div class="fr-book-actions">
          <a href="https://www.amazon.com/s?k=DEADLY+FEASTS+CASSETTE+Richard+Rhodes&amp;i=stripbooks&amp;tag=searcht-20" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
            See on Amazon
          </a>
        </div>
      </div>
