...
show_ads: true
description: Medical treatment can document suffering, but it does not automatically prove what caused the illness.
hero_summary: Medical treatment can document suffering, but it does not automatically prove what caused the illness.
layout: default
permalink: /medical-cause/
sidebar_expanded_urls:
- /cash-landrum-ufo-incident/
- /injury-cases/
nav_short_title: Medical Cause
title: What medical records could and could not prove
title_full: What medical records could and could not prove
display_title_short: Medical Cause
display_title: Medical Cause
heading_title: What medical records could and could not prove
page_heading_title: What medical records could and could not prove
source_count: 33
infographic_count: 3
planned_sections:
- How records can confirm symptoms and treatment
- Why causation needs more than a diagnosis label
- Where the Cash Landrum paper trail remains disputed
...
next_link:
  ...
  heading_title: Why this injury case stood apart
header:
  og_image: /assets/images/cash_landrum_ufo_inc_db9d45_injury_based_ufo_cas_3c0803_medical_records_caus_9fb1ed-Illustration-1-social.jpg
  preview_image: /assets/images/cash_landrum_ufo_inc_db9d45_injury_based_ufo_cas_3c0803_medical_records_caus_9fb1ed-Illustration-1.webp
image: /assets/images/cash_landrum_ufo_inc_db9d45_injury_based_ufo_cas_3c0803_medical_records_caus_9fb1ed-Illustration-1-social.jpg
---

## Introduction

The medical records associated with the Cash-Landrum incident are often cited as the strongest part of the case because they document that the witnesses, especially [Betty Cash]({{ 'betty-cash/' | relative_url }}), sought medical treatment after the alleged encounter. However, the central evidential question has never been whether treatment occurred. It has been whether the reported sighting caused the illnesses.
...
* What physicians observed during examinations.
* What treatments were prescribed.
* Whether symptoms improved, worsened, or persisted.
* Whether the complaints were contemporaneous with the claimed event.
...
* Measured exposure to a harmful agent.
* Laboratory findings consistent with that exposure.
* A dose level capable of producing the observed effects.
* Exclusion of plausible alternative explanations.
* A biologically coherent relationship between exposure and outcome.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides comparative cases involving documentary evidence.</p>
        <div class="fr-book-actions">
