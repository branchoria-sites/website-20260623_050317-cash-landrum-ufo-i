...
- cash_landrum_ufo_inc_db9d45_case_file_evidence_m_6272c9_index
...
show_ads: true
description: Medical summaries, interviews, legal records, and correspondence each support different parts of the story.
hero_summary: Medical summaries, interviews, legal records, and correspondence each support different parts of the story.
layout: default
permalink: /case-file/
sidebar_expanded_urls:
- /cash-landrum-ufo-incident/
nav_short_title: Case File
title: What Evidence Exists in the Case File?
title_full: What Evidence Exists in the Case File?
display_title_short: Case File
display_title: Case File
heading_title: What Evidence Exists in the Case File?
page_heading_title: What Evidence Exists in the Case File?
source_count: 53
infographic_count: 3
planned_sections:
...
image: /assets/images/cash_landrum_ufo_inc_db9d45_case_file_evidence_m_6272c9-overview-social.jpg
---

## Introduction

The Cash-Landrum case file is best understood as an evidence map rather than a single, tidy proof package. It contains [medical summaries]({{ 'medical-gaps/' | relative_url }}), witness interviews, civilian UFO-investigation notes, Air Force and Army correspondence, legal filings, and later critical reviews. Each category supports a different part of the story: the medical papers document illness, the interviews document what Betty Cash, [Vickie Landrum]({{ 'vickie-landrum/' | relative_url }}) and Colby Landrum said, the official records test whether helicopters or aircraft can be traced to the government, and the legal papers show why the claim failed in court.
...
<img src="{{ "/assets/images/cash_landrum_ufo_inc_db9d45_case_file_evidence_m_6272c9-Illustration-1-dark.svg" | relative_url }}" alt="Case File illustration 1" data-theme-src-dark="{{ "/assets/images/cash_landrum_ufo_inc_db9d45_case_file_evidence_m_6272c9-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/cash_landrum_ufo_inc_db9d45_case_file_evidence_m_6272c9-Illustration-1-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Medical records and summaries
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Helps readers evaluate evidence claims and investigative standards.</p>
        <div class="fr-book-actions">
