...
- cash_landrum_ufo_inc_db9d45_hair_loss_symptoms_d_4aff86_index
...
show_ads: true
description: Hair loss became one of the case's most dramatic claims, but interpretation of the symptom remains contested.
hero_summary: Hair loss became one of the case's most dramatic claims, but interpretation of the symptom remains contested.
layout: default
permalink: /hair-loss/
sidebar_expanded_urls:
- /cash-landrum-ufo-incident/
nav_short_title: Hair Loss
title: What Does the Hair Loss Claim Prove?
title_full: What Does the Hair Loss Claim Prove?
display_title_short: Hair Loss
display_title: Hair Loss
heading_title: What Does the Hair Loss Claim Prove?
page_heading_title: What Does the Hair Loss Claim Prove?
source_count: 81
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Did the Encounter Leave Physical Traces?
header:
  og_image: /assets/images/cash_landrum_ufo_inc_db9d45_hair_loss_symptoms_d_4aff86-overview-social.jpg
  preview_image: /assets/images/cash_landrum_ufo_inc_db9d45_hair_loss_symptoms_d_4aff86-overview.webp
image: /assets/images/cash_landrum_ufo_inc_db9d45_hair_loss_symptoms_d_4aff86-overview-social.jpg
---
...
The strongest reading is therefore narrower than the dramatic version: Cash appears to have had a real and distressing scalp-hair problem after the incident, but the available medical details fit disputed dermatological explanations better than a simple [radiation]({{ 'radiation/' | relative_url }}) narrative. Hair loss matters in the case because it looks evidential; it misleads when detached from dose, timing, distribution, other symptoms, and medical records.
